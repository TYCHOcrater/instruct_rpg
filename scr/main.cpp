...
int main (void) {
    ...
    ifstream Potions("input/Potions.txt");
    if(!Potions){
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream Armory("input/Armory.txt");
    if(!Armory){
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream Weaponry("input/Weaponry.txt");
    if(!Weaponry) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }

    ifstream FireSpells("input/FireSpells.txt");
    if(!FireSpells) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream IceSpells("input/IceSpells.txt");
    if(!IceSpells) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream LightingSpells("input/LightingSpells.txt");
    if(!LightingSpells) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream Warriors("input/Warriors.txt");
    if(!Warriors) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream Sorcerers("input/Sorcerers.txt");
    if(!Sorcerers) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream Paladins("input/Paladins.txt");
    if(!Paladins) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }

    ifstream Dragons("input/Dragons.txt");
    if(!Dragons){
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream Spirits("input/Spirits.txt");
    if(!Spirits) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ifstream Exoskeletons("input/Exoskeletons.txt");
    if(!Exoskeletons) {
        cout << "Cannot open file\n" << endl;
        return 1;
    }
    ...
    while(LightingSpells >> nam >> cost >> minL >> loss >> mP >> red) {
        ThisMarket.Insert_LightningSpell(nam, cost, minL, loss, mP, red);
    }
