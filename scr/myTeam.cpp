...
void MyTeam::Insert_Warrior(string name, int magicP, int strength, int agility, int dexterity, int money, int experience) {

    Hero *newHero = new Warrior(name,magicP,strength,agility,dexterity,money,experience);
    Warriors.push_back(NewHero);
}

void MyTeam::Insert_Sorcerers(string name, int magicP, int strength, int agility, int dexterity, int money, int experience) {
    Hero *NewHero = new Sorcerer(name,magicP,strength,agility,dexterity,money,experience);
    Sorcerers.push_back(NewHero);
}

void MyTeam::Insert_Paladins(string name, int magicP, int strength, int agility, int dexterity, int money, int experience) {
...
void MyTeam::add_player(std::string name) {
    if(my_heroes.size() >= 3) {
        ...
        Hero* hero = Search_hero(name);
        if(hero->get_classType() == "Warrior") {
